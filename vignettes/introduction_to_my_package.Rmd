...
```r
# Load example dataset with drug names including milligrams
...
```r
data(example_drug_data_with_mg)
head(example_drug_data_with_mg)
```

### `example_reference_data``

This dataset is a reference dataset containing example ATC codes and corresponding drug names for drug matching.

```r
data(example_reference_data)
example_reference_data$ATC_codes
example_reference_data$drug_names
```
